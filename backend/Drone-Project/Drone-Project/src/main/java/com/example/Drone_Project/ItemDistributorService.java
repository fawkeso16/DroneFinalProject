...
public class ItemDistributorService {
    ...
    public void addPriorityItems(List<Item> items) {
    ...
    public void addPriorityItem(Item item) {
        if (item != null && item.getPickUpStation() != null) {
            ...
            Item.CurrentItemsAvailable.getItemsForDelivery();
    ...
    public PriorityBlockingQueue<Item> getItemsForDelivery() {
        return Item.CurrentItemsAvailable.getItemsForDelivery();
    }
    ...
    public void addDefinedItems(java.util.HashMap<String, java.util.Map<Node, PickupStation>> itemsMap) {
        ...
        for (java.util.Map.Entry<String, java.util.Map<Node, PickupStation>> entry : itemsMap.entrySet()) {
            ...
            Item item = new Item(itemId, stationMap.values().iterator().next(), location);
            Item.CurrentItemsAvailable.addItem(item);
